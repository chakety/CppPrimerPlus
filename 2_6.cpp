...
An astronomical unit is the average distance from the earth to the sun (about 150,000,000 km or 93,000,000 miles),
 ...
 (The nearest star after the sun is about 4.2 light years away.) Use type double(as in Listing 2.4) 
...
double lightConvert(double lyear);
...
int main(){
    ...
    double atUtil = lightConvert(lyear);

    cout<<lyear<<" light year = " << atUtil <<" astronomical units."<<endl;
